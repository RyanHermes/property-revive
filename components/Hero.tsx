...
export default function Hero() {
    ...
    return (
        <animated.div className="hero-text mt-20 md:mt-20 flex flex-col items-center justify-center" style={fade}>
            ...
            <h2 className="font-normal text-center">Let Property Revive Refresh Your Home!</h2>
        </animated.div>
    )
}